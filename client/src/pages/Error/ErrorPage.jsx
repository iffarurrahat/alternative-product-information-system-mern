        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-center min-h-screen">
          <div className="text-center md:text-start">
            ...
            <p className="w-full lg:w-2/3 mx-auto md:mx-0">
              Looks like you have reached a broken link. No worries, head back
              to the homepage or try a search!
            </p>
          ...
          <img
            ...
            alt="error image"
            className="w-60 sm:w-72 md:w-96 lg:w-[450px] mb-4 md:mb-0 ml-16 md:ml-0"
          />
        </div>
      </Container>
    </div>
